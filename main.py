...
dataframe = pd.DataFrame({"Name":names_list, "Bio": bio_list, "Following Count":following_list, "Followers Count":followers_list, "Location":location_list, "Website":website_list})
dataframe.to_csv("csv/twitter_data.csv")
